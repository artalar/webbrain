...
export default {
  ...
  'tool.webmcp': 'Using page WebMCP tool',
  ...
  'st.display.webmcp.label': 'WebMCP page tools',
  'st.display.webmcp.desc': 'Discover page-declared WebMCP tools via Chrome DevTools Protocol and load them into the model tool list. Prefer structured page tools over DOM click/type when available. Requires Chrome with WebMCP (origin trial or chrome://flags/#enable-webmcp-testing). Mutating tools still need Act mode and a permission grant.',
